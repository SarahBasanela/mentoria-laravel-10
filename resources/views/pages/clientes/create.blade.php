...
@section('content')
    ...
    <form class="form" method="POST" action={{ route('cadastrar.cliente') }}>
        ...
        <h1 class="h2">Criar Novo Cliente</h1>
            ...
            <input value="{{ old('nome') }}" type="text" class="form-control @error('nome') is-invalid @enderror " name="nome">
            @if ($errors->has('nome'))
        ...
        <div class="mb-3">
            ...
            <input value="{{  old('logradouro') }}"  class="form-control @error('logradouro') is-invalid @enderror " name="emlogradouroail">
